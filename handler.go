...
// NewTextHandler creates a [slog.Handler] that writes tinted text logs to Writer w,
// using the Options opts. If opts is nil, the default options are used.
...
// NewHandler creates a [slog.Handler] that writes tinted text logs to Writer w,
// using the Options opts. If opts is nil, the default options are used.
//
...
// NewJSONHandler creates a [slog.Handler] that writes tinted json logs to Writer w,
// using the Options opts. If opts is nil, the default options are used.
